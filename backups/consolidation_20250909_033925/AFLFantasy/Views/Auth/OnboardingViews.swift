...
extension AFLTeam {
    ...
    var colors: [Color] {
        ...
        case .greaterWesternSydney: [.orange, .black]
        case .hawthorn: [Color(red: 0.47, green: 0.27, blue: 0.07), .yellow] // Hawks brown
        case .melbourne: [.red, .blue]
        case .northMelbourne: [.blue, .white]
        case .portAdelaide: [Color(red: 0.0, green: 0.27, blue: 0.53), .white] // Port navy
    ...
    // Use fullName as the string representation for display
...
class OnboardingCoordinator: ObservableObject {
    ...
    @Published var validationError: OnboardingError?
...
struct CredentialsView: View {
    ...
    private func handleQRCodeResult(_ qrContent: String) {
        ...
        } else if qrContent.allSatisfy(\.isNumber), qrContent.count >= 4 {
    ...
    private func validateTeamId(_ teamId: String) {
        ...
        } else if cleaned.allSatisfy(\.isNumber), cleaned.count >= 4, cleaned.count <= 10 {
