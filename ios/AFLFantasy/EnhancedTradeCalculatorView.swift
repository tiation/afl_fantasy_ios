...
// MARK: - Enhanced Trade Calculator View
...
struct EnhancedTradeCalculatorView: View {
    ...
    // Filtering
    @State private var priceRange: ClosedRange<Double> = 300000...1000000
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            if appState.tradeRecommendations.isEmpty {
                ...
                LazyVStack(spacing: 12) {
                    ForEach(Array(appState.tradeRecommendations.prefix(3).enumerated()), id: \\.offset) { index, recommendation in
