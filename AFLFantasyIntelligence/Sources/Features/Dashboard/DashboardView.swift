...
struct DashboardView: View {
    ...
    private var headerSection: some View {
        ...
        .dsAccessibility(label: "Current team score is \(viewModel.liveStats.currentScore) points in round \(viewModel.weeklyStats.round)")
    }
