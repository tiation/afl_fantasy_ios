...
struct TradeAnalysisCard: View {
    ...
    private var netCostColor: Color {
        ...
        return cost <= 0 ? .green : cost <= 100000 ? .orange : .red
    }
    ...
    private var valueRating: String {
        let pointsPerDollar = (playerIn.averageScore - playerOut.averageScore) / Double(max(playerIn.price - playerOut.price, 1000)) * 10000
