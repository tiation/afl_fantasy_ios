...
public struct AFLPlayer: Codable, Identifiable, Equatable, Hashable {
    ...
    public init(id: String, name: String, team: String, position: String, price: Double, averageScore: Double, projectedScore: Double, ownership: Double, breakeven: Int) {
        self.id = id
        self.name = name
        self.team = team
    ...
    public init(id: String, name: String, team: String, position: Position, price: Int, average: Double, projected: Double, ownership: Double, breakeven: Int) {
        self.init(
            id: id,
            name: name,
            team: team,
