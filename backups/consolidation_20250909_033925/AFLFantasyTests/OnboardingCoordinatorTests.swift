...
// MARK: - OnboardingCoordinatorTests
...
final class OnboardingCoordinatorTests: XCTestCase {
    ...
    func testErrorRecoveryMessages() {
        ...
        XCTAssertEqual(
            credentialsError.recoveryMessage,
    ...
    func testStepNumberConsistency() {
        ...
        XCTAssertEqual(
            OnboardingCoordinator.OnboardingStep.createTeamGuide.stepNumber,
...
// MARK: - OnboardingIntegrationTests
