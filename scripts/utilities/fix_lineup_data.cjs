/**
 * Fix Lineup Data with Exact Values
 * 
...
function updateTeamWithExactData(teamData) {
  ...
  // BENCH - DEFENDERS
  findAndUpdatePlayer(teamData, "Conor Stone", {
    price: 441000,
    team: "Giants",
    position: "DEF",
    breakEven: 25,
  ...
  findAndUpdatePlayer(teamData, "James Leake", {
    price: 246000,
    team: "Swans",
    position: "DEF",
    breakEven: 24,
  ...
  // BENCH - MIDFIELDERS
  findAndUpdatePlayer(teamData, "Hugh Boxshall", {
    price: 230000,
    team: "Kangaroos",
    position: "MID",
    breakEven: 43,
  ...
  // BENCH - RUCKS
  findAndUpdatePlayer(teamData, "Harry Boyd", {
    price: 268000,
    team: "Bulldogs",
    position: "RUC",
    breakEven: -4,
  ...
  // BENCH - FORWARDS
  findAndUpdatePlayer(teamData, "Izak Rankine", {
    price: 907000,
    team: "Crows",
    position: "FWD",
    breakEven: 91,
  ...
  findAndUpdatePlayer(teamData, "Sam Davidson", {
    price: 626000,
    team: "Lions",
    position: "FWD",
    breakEven: 65,
  ...
  findAndUpdatePlayer(teamData, "Caiden Cleary", {
    price: 457000,
    team: "Giants",
    position: "FWD",
    breakEven: 10,
  ...
  findAndUpdatePlayer(teamData, "Campbell Gray", {
    price: 236000,
    team: "Hawks",
    position: "FWD",
    breakEven: 21,
  ...
  // BENCH - UTILITY
  updatePlayer(teamData.bench.utility, "Finn O'Sullivan", {
    price: 397000,
    team: "Kangaroos",
    position: "MID",
    breakEven: 45,
...
function findAndUpdatePlayer(teamData, playerName, newData) {
  // Try to find the player in all possible positions
  const sections = [
    'defenders', 'midfielders', 'rucks', 'forwards',
    'bench.defenders', 'bench.midfielders', 'bench.rucks', 'bench.forwards'
  ];
  ...
  for (const section of sections) {
    ...
    // Navigate to the nested object if needed
    ...
    if (current) {
      const playerIndex = current.findIndex(player => player.name === playerName);
      if (playerIndex !== -1) {
        current[playerIndex] = { 
          ...current[playerIndex], 
          ...newData,
        ...
        console.log(`Updated ${playerName} (found in ${section}) with accurate data`);
        return true;
      }
    }
  }
  
  console.log(`Player ${playerName} not found in any position group`);
  return false;
}
